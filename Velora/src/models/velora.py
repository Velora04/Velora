...
Este módulo implementa el modelo VELORA que combina diferentes expertos
mediante un sistema de enrutamiento neuronal.
"""
import torch
...
class VELORA(nn.Module):
    ...
    def __init__(self, config, math_expert=None, language_expert=None, freeze_experts=False):
        """
        ...
        Args:
            ...
            language_expert: Experto de lenguaje pre-entrenado (opcional)
        ...
        if config.use_memory:
            self.memory_gate = nn.Linear(self.hidden_dim, 1)
