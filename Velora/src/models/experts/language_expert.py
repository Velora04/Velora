# src/models/experts/language_expert.py
import torch
...
class LanguageExpert(nn.Module):
    ...
    def __init__(self, input_dim=128, hidden_dim=256, vocab_size=10000):
        ...
        self.query_classifier = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(hidden_dim // 2, 3)  # pregunta, comando, declaración
        )
        ...
        # Proyector de salida
        self.output_projector = nn.Linear(hidden_dim, input_dim)
    ...
    # src/models/experts/language_expert.py (continuación)
